...
public class PenniesConversion {
    ...
    public static void getDollars(){
        dollars = pennies/100;
        pennies = pennies % 100;
        System.out.println("You have " + "$"+dollars + " in your piggy bank");
        System.out.println("The remaining pennies are " + pennies);
    }
    public static  void getQuarters(){
        quarters = pennies / 25;
        pennies = pennies % 25;
        System.out.println("You have " + quarters + " quarters " + " in your piggy bank");
    }
    public static void getDimes(){
        dimes = pennies / 10;
        pennies = pennies % 10;
        System.out.println("You have " + dimes + " dimes " + " in your piggy bank");

    }
    public static  void getNickels(){
        nickels = pennies / 5;
        pennies = pennies % 5;
        System.out.println("You have " + nickels + " nickels " + " in your piggy bank");
    }
}
